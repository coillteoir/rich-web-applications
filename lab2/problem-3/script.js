var searchGithub = function () {
    ...
    }).then(function (data) { return generatePage(data); });
};
var generatePage = function (data) {
    ...
    document.getElementById("gistText").innerText = ("Number of Gists: " + data.public_gists);
    ...
    }).then(function (data) { return generateRepos(data); });
};
